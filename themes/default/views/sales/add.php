    ...
    $(document).ready(function () {
		...
		$('#before_sub').click(function (e) {
			...
			$('.qty_rec').each(function() {
				...
				var qty_sale = tr.find('.qty_sale').val() - 0;
				...
				if(qty_balance < 0) {
					...
					if(received_qty > oh_qty || qty_sale > oh_qty) {
						message += '- ' + product_name +' : Order Quantity = ' + formatDecimal(received_qty) + ', QOH = ' + formatDecimal(oh_qty) + ' !\n';
						help = true;
					}
				}
			});
